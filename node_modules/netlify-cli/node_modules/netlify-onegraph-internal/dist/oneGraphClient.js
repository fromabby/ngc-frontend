        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (resp.status < httpOkLow || resp.status > httpOkHigh) {
                    internalConsole_1.internalConsole.debug("Response: " + JSON.stringify(respBody, null, 2));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (value.errors) {
                    internalConsole_1.internalConsole.warn("Errors seen fetching Netlify Graph upstream for " + operationName + ": " + JSON.stringify(value.errors, null, 2));
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                internalConsole_1.internalConsole.warn("Network error fetching Netlify Graph upstream:\n" + JSON.stringify(networkError_2, null, 2));
                return [2 /*return*/, {}];
            case 4: return [2 /*return*/];
        }
    });
...
var fetchCliSession = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var appId, authToken, sessionId, desiredEventCount, next, session;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                session = ((_b = (_a = next.data) === null || _a === void 0 ? void 0 : _a.oneGraph) === null || _b === void 0 ? void 0 : _b.netlifyCliSession) || [];
                return [2 /*return*/, { session: session, errors: next.errors }];
        }
    });
}); };
